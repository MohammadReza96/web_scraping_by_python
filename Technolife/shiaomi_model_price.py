...
for num in range(1,8):
    req=requests.get("https://www.technolife.ir/product/list/69_70_79/%DA%AF%D9%88%D8%B4%DB%8C-%D9%85%D9%88%D8%A8%D8%A7%DB%8C%D9%84-%D8%B4%DB%8C%D8%A7%D8%A6%D9%88%D9%85%DB%8C-xiaomi?keywords=&sort=order-desc&page="+str(num))
...
#----------------------------------------------------------------------------------------
try:
    with open('shiaomi_model_price.json',"w",encoding="utf8") as file1:
